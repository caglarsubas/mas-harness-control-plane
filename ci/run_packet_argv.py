...
CHILD_ENV = {
    ...
    "GITHUB_WORKSPACE", "HOME", "LANG", "LC_ALL", "LOGNAME", "PATH", "TMPDIR", "USER",
    "NODE_OPTIONS", "NEXT_TELEMETRY_DISABLED", "NPM_CONFIG_CACHE", "npm_config_audit",
    "npm_config_fund", "npm_config_offline", "npm_config_update_notifier",
    "PYTHONDONTWRITEBYTECODE", "PYTHONPATH", "SOURCE_DATE_EPOCH", "VIRTUAL_ENV",
    "UV_CACHE_DIR", "UV_FROZEN", "UV_NO_SYNC", "UV_OFFLINE", "UV_PROJECT_ENVIRONMENT",
    "UV_PYTHON_DOWNLOADS", "HARNESS_OFFLINE_BACKEND", "HARNESS_OFFLINE_ENFORCED",
